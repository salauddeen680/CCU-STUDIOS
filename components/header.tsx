      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <Link href="/" className="flex items-center gap-2.5 focus:outline-none group">
          <div className="relative h-8 w-11 sm:h-9 sm:w-12 shrink-0 overflow-hidden rounded-md border border-red-500/50 shadow-[0_0_12px_rgba(220,38,38,0.4)]">
            <Image src="/ccu-logo.png" alt="CCU" fill priority className="object-cover" sizes="48px" />
          </div>
              ...
              <div className="pt-4 border-t border-white/10">
                {user ? (
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={handleLogout} className="rounded-lg bg-zinc-900 border border-white/10 px-3 py-1.5 text-xs font-bold text-red-500 hover:bg-zinc-800">
                      Logout
                    </button>
                  </div>
                ) : (
